...
HD_PWD='D:/CHACKS/ladner_fisher_16 - Copy - Copy - Copy/ladner_fisher_16.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ladner_fisher_16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ladner_fisher_16.tcl
