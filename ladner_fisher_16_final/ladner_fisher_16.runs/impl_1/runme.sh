...
HD_PWD='D:/CHACKS/ladner_fisher_16 - Copy - Copy - Copy/ladner_fisher_16.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ladner_fisher_16.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ladner_fisher_16.tcl -notrace
